...
const Navbar = ({theme, setTheme}) => {
  ...
  return (
    ...
    sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium by-white/50
    dark:bg-gray-900/70'> 
      <img src={theme === 'dark' ? assets.logo_dark: assets.logo}
        ...
        max-sm:pt-20 flex sm:items-center gap-5 transition-all duration-300 ease-in-out`}>
        ...
        <div className='flex items-center gap-2 sm:gap-4'>
          ...
          <ThemeToggleBtn theme={theme} setTheme={setTheme}/>
            ...
            <img src={theme === 'dark' ? assets.menu_icon : assets.menu_icon} 
