...
const Footer = ({theme}) => {
  return (
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-30
    sm:px-10 lg:px-24 xl:px-40'>
      ...
      className='w-full p-3 text-sm outline-none rounde
    ...
    justify-center sm:justify-between gap-4 flex-wrap'>
      <p>Copyright 2026 @ Jawa Sakher - All Right Reserved.</p>
